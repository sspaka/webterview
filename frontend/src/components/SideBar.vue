<template>
  <div class="icon-bar btn-group-toggle" data-toggle="buttons">
    ...
    <router-link @click="clickTab" to="/webterview/meetingroom_man">미팅룸관리</router-link>
    <router-link @click="clickTab" to="/webterview/applicant_man">지원자관리</router-link>
    <router-link @click="clickTab" to="/webterview/boards">게시판</router-link>
    <router-link @click="clickTab" to="/webterview/ranking">순위</router-link>
    <div class="dropdown-center">
      ...
      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser1" style="background-color: #1b3b5b">
        <router-link @click="clickTab" :to="{ name: 'profile', params: { useremail } }">프로필</router-link>
