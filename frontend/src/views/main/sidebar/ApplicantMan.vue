    ...
    <div class="container-login100 shadow-lg">
      <div class="wrap-login100" style="margin-left: 20%; margin-right: 5%">
        ...
        <div class="d-flex justify-content-between">
          <form
            @submit.prevent="uploadApplicant"
            style="margin-right: 10px; margin-top: 10px"
          >
            <div class="filebox d-flex flex-col">
              <div>
                <label class="col-lg-3 col-form-label" for="file"
                  >지원자파일<span class="text-danger">*</span></label
                >
                <input
              ...
              <div style="margin-top: 15px; justify-content: space-between">
                <i
                  ...
                  @click="downloadEx('applicant')"
                  >예시</i
                >
                <button type="submit" class="btn btn-primary mx-2 uploadFile">
                  업로드
                </button>
                <button
                  type="button"
                  class="btn btn-danger mx-2 deleteFile"
                  @click="removeApplicants(groupNo)"
                >
                  삭제
                </button>
                <button
                  type="button"
                  class="btn btn-info mx-2 send"
                  @click="sendLink"
                >
                  메일전송
                </button>
          ...
          >
            <div class="filebox d-flex flex-col">
              <div>
                <label class="col-lg-3 col-form-label" for="file"
                  >자기소개서<span class="text-danger">*</span></label
                >
                <input
                  class="form-control form-control-sm"
                  type="file"
                      ...
                      <input
                        ...
                        @click="
                          goApplicantDetail({
                            ...
                            groupNo: applicant.groupNo,
                            roomNo: applicant.roomNo,
                            roomIdx: applicant.roomIdx,
  ...
  methods: {
    ...
    sendLink() {
      for (var i = 0; i < this.applicants.length; i++) {
        this.mailList.push({
          email: this.applicants[i].applicantEmail,
