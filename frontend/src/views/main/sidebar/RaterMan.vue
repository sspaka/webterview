  ...
  <div class="limiter">
    <div class="container-login100 shadow-lg">
      <div class="wrap-login100" style="margin-left: 20%; margin-right: 5%">
        ...
        <form @submit.prevent="uploadRaters">
          <div class="filebox">
            ...
            <div style="margin-top: 15px; justify-content: space-between">
              <button
                type="submit"
                class="btn btn-primary mx-2 uploadFile"
                style="float: left"
              >
                업로드
              </button>
              <button
                type="button"
                class="btn btn-danger mx-2 deleteFile"
                @click="removeRaters(userNo)"
              >
                삭제
              </button>
              <button
                type="button"
                class="btn btn-success mx-2 addFile"
        ...
        <form
          v-if="isWantUpload"
          @submit.prevent="uploadRater(credentials)"
          style="width: 60vh; margin-top: 30px"
        >
          <div class="form-group row">
            <label for="RaterName" class="col-4 col-form-label">이름: </label>
            <input
              v-model="credentials.raterName"
              class="form-control inputNew col-8"
              id="RaterName"
              type="text"
          ...
          <div class="form-group row">
            <label for="RaterEmail" class="col-4 col-form-label"
              >이메일:
            </label>
            <input
              v-model="credentials.raterEmail"
              class="form-control inputNew col-8"
              id="RaterEmail"
              type="email"
          ...
          <div class="form-group row">
            <label for="RaterPhone" class="col-4 col-form-label"
              >전화번호:
            </label>
            <input
              v-model="credentials.raterPhone"
              class="form-control inputNew col-8"
              id="RaterPhone"
              type="tel"
          ...
          <div class="form-group row">
            <label for="RoomNo" class="col-4 col-form-label"
              >방번호(있는 방번호 입력해야)</label
            >
            <input
              v-model="credentials.roomNo"
              class="form-control inputNew col-8"
              id="RoomNo"
              type="text"
          ...
          <div class="form-group row">
            <label for="userNo" class="col-4 col-form-label"
              >관리자 번호:
            </label>
            <input
              v-model="credentials.userNo"
              class="form-control inputNew col-8"
              id="userNo"
              type="text"
              placeholder="관리자 번호"
          ...
          <button class="btn btn-primary mx-2 uploadFile" type="submit">
            개별 업로드
          </button>
        </form>
        <!-- 개별 추가 모달 -->
        <div id="modal" v-if="isModalViewed">
          ...
          <div id="modal-card">
            ...
            >
              <div class="form-group row">
                <label for="RaterName" class="col-4 col-form-label"
                  >이름:
                </label>
                <input
                  v-model="credentials.raterName"
